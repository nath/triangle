...
public class VarianceChecker implements Visitor {
    public Object visitAssignCommand(AssignCommand ast, Object o) {
        ast.V.invariant = false;
        if (ast.V instanceof SimpleVname) {
            ((ArrayList<String>) o).add(((SimpleVname) ast.V).I.spelling);
        }
        ast.V.visit(this, o);
        ast.E.visit(this, o);
        return null;
    ...
    public Object visitArrayExpression(ArrayExpression ast, Object o) {
        ast.AA.visit(this, o);
        ast.invariant = ast.invariant && ast.AA.invariant;
        return null;
    }
    ...
    public Object visitBinaryExpression(BinaryExpression ast, Object o) {
        ...
        ast.E1.visit(this, o);
        ast.E2.visit(this, o);
        ast.invariant = ast.invariant && ast.E1.invariant && ast.E2.invariant;
        return null;
    }
    ...
    public Object visitIfExpression(IfExpression ast, Object o) {
        ...
        ast.E2.visit(this, o);
        ast.E3.visit(this, o);
        ast.invariant = ast.invariant && ast.E1.invariant && ast.E2.invariant && ast.E3.invariant;
        return null;
    }
    ...
    public Object visitLetExpression(LetExpression ast, Object o) {
        ast.D.visit(this, o);
        ast.E.visit(this, o);
        ast.invariant = ast.invariant && ast.E.invariant;
        return null;
    }
    ...
    public Object visitRecordExpression(RecordExpression ast, Object o) {
        ast.RA.visit(this, o);
        ast.invariant = ast.invariant && ast.RA.invariant;
        return null;
    }
    ...
    public Object visitVnameExpression(VnameExpression ast, Object o) {
        ast.V.visit(this, o);
        ast.invariant = ast.invariant && ast.V.invariant;
        return null;
    }
    ...
    public Object visitMultipleArrayAggregate(MultipleArrayAggregate ast, Object o) {
        ast.E.visit(this, o);
        ast.AA.visit(this, o);
        ast.invariant = ast.invariant && ast.E.invariant && ast.AA.invariant;
        return null;
    }
    ...
    public Object visitMultipleRecordAggregate(MultipleRecordAggregate ast, Object o) {
        ast.E.visit(this, o);
        ast.RA.visit(this, o);
        ast.invariant = ast.invariant && ast.E.invariant && ast.RA.invariant;
        return null;
    }
    ...
    public Object visitSimpleVname(SimpleVname ast, Object o) {
        ast.invariant = !((ArrayList<String>) o).contains(ast.I.spelling);
        return null;
    }
    ...
    public Object visitSubscriptVname(SubscriptVname ast, Object o) {
        ast.V.visit(this, o);
        ast.E.visit(this, o);
        ast.invariant = ast.invariant && ast.V.invariant && ast.E.invariant;
        return null;
    }
